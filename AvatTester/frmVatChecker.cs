    ...
    public partial class frmVatChecker : Form, IValidationObserver
    {
        ...
        private void btnBlacklistImport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var count = AvatValidator.Validators.BlackListValidator.Entities.BlackListManager.ImportDataFromXml(xml, DbProvider.DefaultDataSource, null);
        ...
        private void btnImportPayers_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var count = AvatValidator.Validators.TaxPayerValidator.Entities.TaxPayersManager.ImportDataFromXml(xml, DbProvider.DefaultDataSource, null);
